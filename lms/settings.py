...
CLOUDSCORM_APP_ID = os.environ.get('CLOUDSCORM_APP_ID')
CLOUDSCORM_SECRET_KEY = os.environ.get('CLOUDSCORM_SECRET_KEY')
CLOUDSCORM_API_URL = os.environ.get('CLOUDSCORM_API_URL')

# SCORMHub API settings
SCORM_API_BASE_URL = os.environ.get('SCORM_API_BASE_URL')
SCORM_API_TOKEN = os.environ.get('SCORM_API_TOKEN')
