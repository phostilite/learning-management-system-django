...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='deliveryattendance',
            name='delivery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendance', to='courses.delivery'),
        ),
        migrations.AddField(
            model_name='deliveryattendance',
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_attendance', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='deliveryemailtemplate',
            name='delivery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='email_templates', to='courses.delivery'),
        ),
        migrations.AddField(
            model_name='deliveryfeedback',
            name='delivery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feedback', to='courses.delivery'),
        ),
        migrations.AddField(
            model_name='deliveryinstructor',
            name='assigned_by',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='instructor_assignments', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='deliveryinstructor',
            name='delivery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_instructors', to='courses.delivery'),
        ),
        migrations.AddField(
            model_name='deliveryinstructor',
            name='instructor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_instructor_roles', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='delivery',
            name='instructors',
            field=models.ManyToManyField(related_name='instructed_deliveries', through='courses.DeliveryInstructor', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='deliveryschedule',
            name='delivery',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='schedules', to='courses.delivery'),
        ),
        migrations.AddField(
            model_name='deliveryattendance',
            name='schedule',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attendance', to='courses.deliveryschedule'),
        ),
        migrations.AddField(
